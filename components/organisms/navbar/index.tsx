...
export const Navbar = () => {
    return (
        <div>
            <header>
                <nav className="fixed inset-x-0 z-40 transition-colors bg-white">
                        ...
                        <div className="max-w-5xl px-4 mx-auto sm:px-6 lg:px-8">
                            <div className="flex items-center justify-between h-16">
                                <div className="basis-1/3">
                                    <Link
                                        href="/"
                                        className="text-3xl font-semibold text-gray-800 font-instagram"
                                    >
                                        Instagram
                                    </Link>
                                </div>
                                ...
                                <div className="basis-1/3">
                                    <div className="relative">
                                        ...
                                        <input
                                            type="search"
                                            name="q"
                                            className="py-2 pl-10 md:w-[260px] text-sm bg-gray-200 rounded-md focus:outline-none text-gray-700"
                                            placeholder="Search"
                                            autoComplete="off"
                                        />
                                    </div>
                                ...
                                <div className="basis-1/3">
                                    <div className="flex items-center space-x-4">
                                        ...
                                        <button
                                            type="button"
                                            className="relative aspect-square h-[25px] rounded-full overflow-hidden"
                                        >
                                            <Image
